# Quality Service OpenAPI Specification
[![Build Status](https://travis-ci.org/luiz-albertoni/OpenAPI.svg?branch=master)](https://travis-ci.org/luiz-albertoni/OpenAPI)
...
6. If you did everything correct, https://luiz-albertoni.github.io/OpenAPI/ will lead to your new docs
...
- Documentation(ReDoc): https://luiz-albertoni.github.io/OpenAPI/
- SwaggerUI: https://luiz-albertoni.github.io/OpenAPI/swagger-ui/
- Look full spec:
    + JSON https://luiz-albertoni.github.io/OpenAPI/swagger.json
    + YAML https://luiz-albertoni.github.io/OpenAPI/swagger.yaml
- Preview spec version for branch `[branch]`: https://luiz-albertoni.github.io/OpenAPI/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://luiz-albertoni.github.io/OpenAPI/ with url from the message: `Server started <url>`
